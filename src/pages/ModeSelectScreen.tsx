...
import HuntingCatIcon from '../assets/imgs/bg/cat-lying.svg'
import ScaredMouseIcon from '../assets/imgs/bg/mouse-scared.svg'
    ...
    <>
      <div className="w-3/4 flex align-stretch justify-center gap-6">
        <Card className="flex-1/2 select-none transition-all duration-300 hover:scale-[1.002] hover:shadow-2xl">
          <CardHeader className="text-lg flex align-center justify-between">
          ...
          <CardContent className="text-justify">
            <p>
              ...
              fitting story. It’s perfect for those moments when you crave a
              mood rather than a genre. Whether you’re winding down after a long
              day or yearning for a bit of wonder, we’ll pick something that
              resonates. You don’t need to name a book or author — just describe
              the feeling, and we’ll handle the rest.
            </p>
          </CardContent>
          <CardFooter>
            <Button
        ...
        <Card className="flex-1/2 select-none transition-all duration-300 hover:scale-[1.002] hover:shadow-2lyxl">
          ...
          <CardContent className="text-justify">
            <p>
              ...
              what you’re looking for and want to fine-tune the experience. You
              can mix and match options to create your perfect story prompt.
              Looking for a dark mystery in a snowy village with an uplifting
              ending? We’ve got you. It’s a great way to explore new books that
              check all your boxes — without endless scrolling and bla bla bla
              bla bla bla.
            </p>
          </CardContent>
          <CardFooter>
      ...
      <img
        src={HuntingCatIcon}
        alt=""
        className="w-50 absolute bottom-[6%] left-[4%]"
      />
      <img
        src={ScaredMouseIcon}
        alt=""
        className="w-14 absolute bottom-[6%] right-[4%] scale-x-[-1]"
      />
    </>
  )
}
